...
//                intent.setData(Uri.parse("market://details?id=com.triedge.ic"));
                ...
                intent.putExtra(Intent.EXTRA_TEXT, " ఇపుడు గూడూరు లోని బంగారు మరియు వెండి (1 గ్రాము) ధరలు మీ ఫోన్  లోనే  చూసుకునే అవకాశం కలదు . డౌన్లోడ్ చేసుకొనవలసిన అప్లికేషన్ లింక్ : \n https://play.google.com/store/apps/details?id=funcentric.com.gsupdates ");
